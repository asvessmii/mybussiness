...
Интеллектуальная система обработки запросов на основе документов и веб-ресурсов для интеграции в веб-сайты и приложения.

## 🚀 Возможности

- **Обработка документов**: Поддержка PDF, DOCX, TXT файлов
- **Семантический поиск**: Интеллектуальный поиск релевантной информации
- **Генерация ответов**: Контекстуально релевантные ответы на основе базы знаний
